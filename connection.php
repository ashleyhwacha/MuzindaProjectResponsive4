...
<!--End Page Header-->
 ...
 <?php
		...
		$result=$conn->query("SELECT * FROM sampledb WHERE departure = '$from' AND arrival = '$to'"); 
...
<td bgcolor="#5D7B9D">
            ...
            <a href="personal_details_form2.php?id=<?php echo $row['id'];?>">
             <font color="red">
